...
namespace EyeTrackingCore
{
    ...
    {
        public readonly List<Saccade> saccadesUsedToGenerateBook = null;
        public readonly List<Fixation> fixationsUsedToGenerateBook = null;
        ...
        {
            this.saccadesUsedToGenerateBook = saccades;
        ...
        {
            this.fixationsUsedToGenerateBook = fixations;
        ...
        private static Dictionary<Token, string> TokenStringRepresentationTable =
